...
<div class="collapse navbar-collapse" id="navbarNav">
	<ul class="navbar-nav">
		<li class="nav-item"><a class="nav-link" aria-current="page"
			href="<%=request.getParameter("home")%>"> <!-- ver aqui --> <svg
		...
		<li class="nav-item"><a class="nav-link"
			href="<%=request.getParameter("destinos")%>"> <!-- ver aqui --> <svg
					xmlns="http://www.w3.org/2000/svg" width="16" height="16"
		...
		<li class="nav-item"><a class="nav-link"
			href="<%=request.getParameter("promocoes")%>"> <!-- ver aqui -->
		...
		<li class="nav-item"><a class="nav-link"
			href="<%=request.getParameter("contato")%>"> <!-- ver aqui --> <svg
					xmlns="http://www.w3.org/2000/svg" width="16" height="16"
		...
		<li class="nav-item"><a class="nav-link"
			href="<%=request.getParameter("reservas")%>"> <!-- ver aqui --> <svg
					xmlns="http://www.w3.org/2000/svg" width="16" height="16"
  ...
  <path
		...
		<li class="nav-item"><a class="nav-link"
			href="<%=request.getParameter("passagens")%>"> <!-- ver aqui -->
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
		...
		<li class="nav-item"><a class="nav-link"
			href="<%=request.getParameter("clientes")%>"> <!-- ver aqui --> <svg
					xmlns="http://www.w3.org/2000/svg" width="16" height="16"
  ...
  <path fill-rule="evenodd"
		...
		<li class="nav-item"><a class="nav-link"
			href="<%=request.getParameter("entrar")%>"> <svg
					xmlns="http://www.w3.org/2000/svg" width="16" height="16"
